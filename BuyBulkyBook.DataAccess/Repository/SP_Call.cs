...
namespace BuyBulkyBook.DataAccess.Repository
{
    class SP_Call : ISP_Call
    {
        ...
        public T OneRecord<T>(string procedureName, DynamicParameters param = null)
        {
            ...
            {
                sqlCon.Open();
                var vaule = sqlCon.Query<T>(procedureName, param, commandType: System.Data.CommandType.StoredProcedure);
                return (T)Convert.ChangeType(vaule.FirstOrDefault(), typeof(T));
            }
        }
